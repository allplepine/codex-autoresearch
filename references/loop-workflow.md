...
8. Record the result through `autoresearch_record_iteration.py` using the current clean HEAD after closeout.
...
- Use `web-search-protocol.md` or `hypothesis-perspectives.md` only when those behaviors are actively in play.
