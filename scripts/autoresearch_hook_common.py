...
HELPER_ROOT_RELATIVE_CANDIDATES = (
    Path(".agents/skills/research-validation-skill"),
    Path(".codex/skills/research-validation-skill"),
)
...
AUTORESEARCH_SKILL_MARKER = "$research-validation-skill"
AUTORESEARCH_BACKGROUND_MARKER = "This repo is managed by the research-validation-skill runtime controller."

HOOK_ACTIVE_ENV = "RESEARCH_VALIDATION_SKILL_HOOK_ACTIVE"
HOOK_RESULTS_PATH_ENV = "RESEARCH_VALIDATION_SKILL_HOOK_RESULTS_PATH"
HOOK_STATE_PATH_ENV = "RESEARCH_VALIDATION_SKILL_HOOK_STATE_PATH"
HOOK_LAUNCH_PATH_ENV = "RESEARCH_VALIDATION_SKILL_HOOK_LAUNCH_PATH"
HOOK_RUNTIME_PATH_ENV = "RESEARCH_VALIDATION_SKILL_HOOK_RUNTIME_PATH"
